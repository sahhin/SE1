...
public class Customer {
  ...
  public Customer(String firstName, String lastName, String emailAddress) throws InvalidEmailException {
  ...
  public String toString() {
    var str = "["+_id+"] "+_firstName+" "+_lastName+", "+_emailAddress.getEmail();
    if (_orders.size() > 0) {
      str += ", Orders: (";
