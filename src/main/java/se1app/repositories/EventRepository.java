...
public class EventRepository {
   ...
   * @return The customer object or 'null' if creation failed. */
    public static Event createEvent(User user, String eventName, Date eventDate, String eventStartTime, String eventEndTime, int eventOrganizerId, int eventStatusId,Neighborhood neighborhood) {
    try {
      var event = new Event(user, eventName, eventDate, eventStartTime, eventEndTime, eventOrganizerId, eventStatusId,neighborhood);
      saveEvent(event);
      return event;
    }
