...
public class CustomerControllerTest {
  ...
  public void setup() {
    ...
    CustomerRepository.createCustomer("Max", "Mustermann", "max-mustermann123@web.de", "Berliner Tor 7");
  ...
  void createCustomerSuccess() {
    ...
    body(new Customer("Maren", "Musterfrau", "mm@gmail.com", "Berliner Tor 7")).
    when().
    post("/customers").
    then().
    statusCode(201);
