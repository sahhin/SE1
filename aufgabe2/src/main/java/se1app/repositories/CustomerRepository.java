...
public class CustomerRepository {
  ...
  public static Customer createCustomer(String firstName, String lastName, String emailAddress, String adresse) {
    try {
      var customer = new Customer(firstName, lastName, emailAddress, adresse);
